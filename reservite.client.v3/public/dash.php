...
<head>
    ...
    <title>Dashboard · Bootstrap v5.3</title>
...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">reservite.v3</a>
    ...
    <div class="container-fluid">
        <div class="row">
            <?php
            include '../src/Pages/main_menu.php';
            if($_GET['page']=='main'){
